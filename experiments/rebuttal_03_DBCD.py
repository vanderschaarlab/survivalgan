...
out_dir = Path("output")
bkp = out_dir / f"metrics.DBCD.bkp"


df, duration_col, event_col, time_horizons = get_dataset("DBCD")
...
scores = Benchmarks.evaluate(
    [
        # ("survival_gan", "survival_gan", {"censoring_strategy" : "covariate_dependent"}),
        ("ctgan", "ctgan", {}),
        ("tvae", "tvae", {}),
